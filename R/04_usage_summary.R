...
write_csv(point_usage, "outputs/point_usage.csv")
write_csv(daily_usage, "outputs/daily_usage.csv")
write_csv(daily_visitors, "outputs/daily_visitors.csv")
write_csv(hourly_usage, "outputs/hourly_usage.csv")
write_csv(weekday_usage, "outputs/weekday_usage.csv")
