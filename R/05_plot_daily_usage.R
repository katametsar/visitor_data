...
daily_usage <- read_csv(
  "~/visitor_data/outputs/daily_usage.csv",
...
ggsave(
  "~/visitor_data/outputs/daily_usage_points.png",
  plot = p_points,
  width = 13,
  height = 6
)
...
ggsave(
  "~/visitor_data/outputs/daily_usage_discontinuous_line.png",
  plot = p_line,
  width = 13,
  height = 6
)
...
write_csv(
  daily_complete,
  "~/visitor_data/outputs/daily_usage_complete_calendar.csv"
)

write_csv(
  coverage_summary,
  "~/visitor_data/outputs/daily_usage_coverage_summary.csv"
)
